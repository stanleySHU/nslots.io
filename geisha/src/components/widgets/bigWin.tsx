...
import { BIG_WIN_PARTICLE } from 'common/components/particle/bigWinV1';
...
export function BigWin({ dataSource }: { dataSource: GameStatusModel }) {
    ...
    return (<Orientation>
        <Layer visible={isShowBigWinAmount}>
            ...
            <Container>
                <ParticleEmitter x={470} y={505} scale={1} playing={isShowBigWinAmount} visible={isShowBigWinAmount} config={BIG_WIN_PARTICLE}></ParticleEmitter>
                <ParticleEmitter x={700} y={505} scale={[-1,1]} playing={isShowBigWinAmount} visible={isShowBigWinAmount} config={BIG_WIN_PARTICLE}></ParticleEmitter>
            </Container>
