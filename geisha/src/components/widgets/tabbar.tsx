...
import { Button, SPressButton } from "common/components/button";
        ...
        <Layer>
            <Orientation>
                <Layer l-x={585} p-x={585} l-pivot={[585, 117]} p-pivot={[585, 82]} ref={tabbar}>
                    ...
                    <SPressButton interactive={isIdle && !isAutoSpin} l-x={50} l-y={73} p-x={330} p-y={-97} l-visible={true} p-visible={true} onpointerup={onMenu}>
                    ...
                    <Layer l-x={280} l-y={35} p-x={383} p-y={15}>
                        ...
                        <Layer l-x={250} l-y={-15} p-x={202} p-y={-15}>
                            {
                                isMobile ? <Layer>
                                    <Button y={52} interactive={isIdle && !isAutoSpin} onpointerup={setSelecterOn.bind(null, true)}>
                                    ...
                                    <Layer>
                                        ...
                                        <Layer y={53}>
                                            <SPressButton l-x={-95} p-x={-75} onpointerup={onMinus} interactive={enableMin}>
                                                <SpriteAtlas name={"bet_minus.png"} anchor={0.5} tint={enableMin ? 0xffffff : 0x888888}></SpriteAtlas>
                                            </SPressButton>
                                            <SPressButton l-x={95} p-x={75} onpointerup={onAdd} interactive={enableMax}>
