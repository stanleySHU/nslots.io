...
export function FiveOfAKind({ dataSource }: { dataSource: GameStatusModel }) {
    ...
    return (<Orientation>
        <Layer visible={isShow5OAK}>
            ...
            <Spine_All playing={isShow5OAK} onComplete={_onComplete} x={585} y={585} l-scale={0.33} p-scale={0.25} actions={useMemoConstant([[0, '5ofakind_OUT', false], [0, '5ofakind_IDLE', false], [0, '5ofakind_ENTER', false]])} timeScale={0.8}></Spine_All>
        </Layer>
    </Orientation>
    )
}
