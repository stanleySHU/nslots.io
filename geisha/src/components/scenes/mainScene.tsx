...
import { Spine_CannonCount, Spine_Number, Spine_Spin } from '../widgets/base';
                ...
                <HandleProps>
                    {
                         ({ dataSource }: { dataSource: GameStatusModel }) => {
                            return (<Scene {...props}>
                                ...
                                <SpriteAtlasLang x={580} l-y={325} p-y={325} anchor={0.5} scale={0.8} name={'logo.png'}></SpriteAtlasLang>
