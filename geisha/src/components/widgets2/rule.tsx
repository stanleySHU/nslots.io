    ...
    return (
        <div className={`page-mod ${payTableOn ? 'db' : 'dn'}`}>
            <div className='rule-bg-mod'>
                <div className={`blur-bg bg ${symbolFormat}`}></div>
            ...
            <div ref={scrollView} className="rule-page-mod hidden-scroolbar" onScroll={onScroll}>
                ...
                <div ref={featuresView} id={'geisha-features'} className='payline-mod'>
                                                    ...
                                                    mapWith(3, (i) => {
                                                        return (
                                                            <div className='s-row' key={`s-${i}`}>
                                                                {
                                                                    mapWith(5, (j) => {
                                                                        return <div key={`payline-i-${j}`} className={`s-item ${item[`${j}${i}`] == true ? 'selected' : ''}`} />
                                                                    })
                                                                }
                                                            </div>
                                                        )
                    ...
                    <div className={`description ${orientation}`}>
                        <DivLang className='text' tcase='upper' replaceMap={{'{%line%}': '9'}}>9lines</DivLang>
                ...
                <div ref={scatterView} className='wild-scatter-mod'>
                    ...
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.English || lang == Languages.Japanese || lang == Languages.IndianHindi) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>The <div className='dib text-coral'>WILD</div> will substitute ALL symbols including <div className='dib text-coral'>SCATTER</div></div>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.Chinese) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'><div className='dib text-coral'>百搭</div>将替代包括<div className='dib text-coral'>夺宝</div>在内的所有图标</div>
                            <div className='text'><div className='dib text-coral'>百搭</div>只出现在2, 3, 4卷轴上。</div>
                            <div className='text'>所有带<div className='dib text-coral'>百搭</div>的中奖组合都是<div className='dib text-coral'>2倍!</div></div>
                        </div>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.Korean) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle', marginTop: '1rem' }}>
                            <div style={{height: '2rem'}}><div className='text'><div className='dib text-coral'>WILD</div> 는 <div className='dib text-coral'>SCATTER</div>를 포함한 모든 심볼을 대체합니다.</div></div>
                            <div className='text'><div className='dib text-coral'>WILD</div> 는 오직 2, 3, 4릴에 나타납니다.</div>
                            <div className='text'>모든 <div className='dib text-coral'>WILD</div>  당첨 조합은 <div className='dib text-coral'>x2</div>  입니다!</div>
                        </div>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.Thai) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            ...
                            <div className='text'>สัญลักษณที่ชนะโดยมีสัญลักษณ์ <div className='dib text-coral'>WILD</div> ผสมอยู่ด้วยจะได้รับรางวัล <div className='dib text-coral'>x 2!</div></div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Turkish) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'><div className='dib text-coral'>WILD</div>,<div className='dib text-coral'>SCATTER</div> dahil TÜM sembollerin yerini alacaktır</div>
                            <div className='text'><div className='dib text-coral'>WILD</div> yalnızca 2, 3, 4 makarada görünecektir</div>
                            <div className='text'><div className='dib text-coral'>WILD</div> ile tüm kazanan kombinasyonlar <div className='dib text-coral'>x 2!</div></div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Portuguese) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>O SÍMBOLO <div className='dib text-coral'>WILD</div> substituirá TODOS os símbolos, incluindo <div className='dib text-coral'>SCATTER</div></div>
                            <div className='text'>O <div className='dib text-coral'>WILD</div> aparecerá apenas nos reels 2, 3 e 4</div>
                            <div className='text'>Todas as combinações vencedoras com o SÍMBOLO <div className='dib text-coral'>WILD</div> têm um multiplicador de <div className='dib text-coral'>x 2!</div></div>
                        </div>
                    </div>
                    <div className='clearfix' style={{ textAlign: 'center', marginTop: '1rem' }}>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.Chinese) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>从最左到右或者从最右到左连续出现2个或更多的<div className='dib text-coral'>夺宝</div></div>
                            <div className='text'>即可获得奖金。</div>
                            <div className='text'><div className='dib text-coral'>夺宝</div>奖金是由获得的倍数乘以总投注额</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Indonesian) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>2 atau lebih <div className='dib text-coral'>SCATTER</div> muncul secara berurutan dari pembayaran</div>
                            <div className='text'>paling kiri ke kanan atau paling kanan ke kiri.</div>
                            <div className='text'>Kemenangan <div className='dib text-coral'>SCATTER</div> dikalikan TOTAL BET.</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Vietnamese) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>Từ 2 biểu tượng <div className='dib text-coral'>SCATTER</div> trở lên xuất hiện liên tiếp từ ngoài cùng bên</div>
                            <div className='text'>trái sang phải hoặc ngoài cùng bên phải sang trái sẽ chiến thắng phần thưởng.</div>
                        ...
                        <div className={`description ${orientation} ${(lang == Languages.Korean) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>2개 이상의 <div className='dib text-coral'>SCATTER</div> 제일 왼쪽에서 오른쪽으로 또는 제일</div>
                            <div className='text'>오른쪽에서 왼쪽으로 연속해서 나올 경우 당첨금이 지급됩니다.</div>
                            <div className='text'><div className='dib text-coral'>SCATTER</div> 당첨은 총 베팅에 곱해져 지급됩니다.</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Khmer) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>និមិត្តសញ្ញា <div className='dib text-coral'>SCATTER</div> 2 ឬច្រើនចេញតាមលំដាប់ពីឆ្វេងទៅស្តាំ </div>
                            <div className='text'>ឬពីស្តាំទៅឆ្វេងនឹងទទួលបានការទូទាត់សង។</div>
                            <div className='text'>ការឈ្នះ <div className='dib text-coral'>SCATTER</div> ត្រូវបានគណនាដោយចំនូនភ្នាល់សរុប</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Thai) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>หากมี สัญลักษณ์ <div className='dib text-coral'>SCATTER</div> ปรากฏขึ้นติดกันตั้งแต่ 2 </div>
                            <div className='text'>อันขึ้นไปจากซ้ายสุดไปขวา หรือจากขวาสุดไปซ้าย ผู้เล่นจะได้รับรางวัล</div>
                            <div className='text'>การชนะสัญลักษณ์ <div className='dib text-coral'>SCATTER</div> จะคูณด้วยการเดิมพันทั้งหมด</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Turkish) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>En soldan sağa veya en sağdan sola ardı ardına görünen 2 veya daha fazla <div className='dib text-coral'>SCATTER</div></div>
                            <div className='text'>ödül ödemesini sağlar.</div>
                            <div className='text'><div className='dib text-coral'>SCATTER</div> kazancı TOPLAM BAHİS ile çarpılır.</div>
                        </div>
                        <div className={`description ${orientation} ${(lang == Languages.Portuguese) ? 'db' : 'dn'}`} style={{ verticalAlign: 'middle' }}>
                            <div className='text'>2 ou mais SÍMBOLOS <div className='dib text-coral'>SCATTER</div> aparecendo consecutivamente da extrema esquerda para a direita</div>
                            <div className='text'>ou da extrema direita para a esquerda concedem pagamento.</div>
                            <div className='text'>O ganho com <div className='dib text-coral'>SCATTER</div> é multiplicado pela APOSTA TOTAL.</div>
                        </div>
                    </div>
                </div>
                <div ref={gamePlayView} id={'geisha-gameplay'} className='game-info-mod'>
                    ...
                    <div className='detail-table'>
                        <div>
                            <div className={`item ${lang}`}>
                                ...
                                <DivLang replaceMap={{'{%reel%}': '3 x 5'}}>3_5reel</DivLang>
                            </div>
                            <div className={`item ${lang}`}>
                                <DivLang>fixedlinesNo</DivLang>
                                <DivLang replaceMap={{'{%line%}': '9'}}>9lines</DivLang>
                            </div>
                            <div className={`item ${lang}`}>
                    ...
                    <div className={`description ${orientation}`}>
                        ...
                        <div><DivLang className='dib text' style={{paddingLeft: '1rem'}} tmp={['1. ', 'howtoplay1']}></DivLang></div>
                        <div><DivLang className='dib text' style={{paddingLeft: '1rem'}} tmp={['2. ', 'howtoplay2']}></DivLang></div>
                        <div><DivLang className='dib text' style={{paddingLeft: '1rem'}} tmp={['3. ', 'howtoplay3']}></DivLang></div>
                    </div>
                </div>
            </div>
