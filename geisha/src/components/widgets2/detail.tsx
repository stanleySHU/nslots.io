                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <th><DivLang className='dib' tcase='upper'>linebet</DivLang><br></br>({currency})</th>
                                        <th><DivLang className='dib' tcase='upper'>totalbet</DivLang><br></br>({currency})</th>
                                        <th><DivLang className='dib' tcase='upper'>totalwin</DivLang><br></br>({currency})</th>
                                </tr>
                            </tbody>
                            <tbody>
                                <tr>
                                    <th>{data.createdOnFormat}</th>
                                    <th>{toCommaAndFixed(Number(data.credit))}</th>
                                                                        ...
                                                                        <tr>
                                                                            {
                                                                                mapWith(5, (j) => {
                                                                                    ...
                                                                                    return <td key={`row${j}`} style={{ width: '1.5rem', height: '1.5rem', fontSize: 0 }}>
                                                                                        {
